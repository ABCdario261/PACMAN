...
typedef struct {
    ...
    int points; // Sinceramente assim fica mil vezes mais fácil
    int thread_shutdown; // Variavel ,antes global, agora unica para cada sessao
    int victory;  //Assim não precisamos de atualizar no pac estes dois
    int end_game;
    int notif_fd;
    int req_fd;
